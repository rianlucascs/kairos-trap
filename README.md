...
| ------------------------------------------------------- | ------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ |
| [`cvm_formulario_informacoes_trimestrais`](docs/pipelines/cvm_formulario_informacoes_trimestrais/data-catalog.md) | [CVM](https://dados.cvm.gov.br/dados/CIA_ABERTA/DOC/ITR/DADOS/) | Extração e processamento dos dados do formulário ITR. |
| [`cvm_formulario_demonstracoes_financeiras_padronizadas`](docs/pipelines/cvm_formulario_demonstracoes_financeiras_padronizadas/data-catalog.md) | [CVM](https://dados.cvm.gov.br/dados/CIA_ABERTA/DOC/DFP/DADOS/) | Extração e processamento dos dados do formulário DFP. |
| [`cvm_cias_abertas_informacao_cadastral`](docs/pipelines/cvm_cias_abertas_informacao_cadastral/data-catalog.md) | [CVM](https://dados.cvm.gov.br/dataset/cia_aberta-cad) | Extração e processamento das informações cadastrais de companhias abertas. |
...
| [`cvm_formulario_de_referencia`](docs/pipelines/cvm_formulario_de_referencia/data-catalog.md) | [CVM](https://dados.cvm.gov.br/dados/CIA_ABERTA/DOC/FRE/DADOS/) | Extração e processamento dos dados do formulário FRE. |
...
| [`b3_enriquecimento_cadastral_ativos`](docs/pipelines/b3_enriquecimento_cadastral_ativos/data-catalog.md) | [B3](https://www.b3.com.br/) | Extração e processamento de informações complementares para enriquecimento cadastral e identificação de ativos financeiros. |
| [`b3_indices_segmentos_setoriais`](docs/pipelines/b3_indices_segmentos_setoriais/data-catalog.md) | [B3](https://www.b3.com.br/pt_br/market-data-e-indices/indices/indices-de-segmentos-e-setoriais/) | Extração e processamento da composição dos índices de segmentos e setoriais. |
